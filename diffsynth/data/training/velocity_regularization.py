...
def evaluate_interpolation(model: "VelocityRegularizationModel", cfg: TrainConfig,
    ...
    try:
        import interpolation_compare_demo as demo
        from reconstruction_compare_demo import _ssim_fn, get_test_clips
        from reconstruction_compare_demo import psnr as _psnr
