#!/bin/bash
#SBATCH --account=3dv
#SBATCH --job-name=gs_mask_eval
#SBATCH --partition=jobs
#SBATCH --time=0-01:00:00
#SBATCH --chdir=/work/courses/3dv/team32/handy-NeoVerse
#SBATCH --output=/work/courses/3dv/team32/handy-NeoVerse/logs/eval_gs_mask_%j.out
#SBATCH --error=/work/courses/3dv/team32/handy-NeoVerse/logs/eval_gs_mask_%j.err
